function [pairChannels, selChannels]= getPairsAndDetectedChannels(indChannels, detectPairInds) 
    ...
    allDetChanns = pairChannels(detectPairInds,:);
    selChannels = unique(allDetChanns(:));
