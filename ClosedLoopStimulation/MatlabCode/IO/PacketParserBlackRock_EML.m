function [neuralData, pktHeader, nspTime] = PacketParserBlackRock_EML(ethPkt, newAcquisition)
...
modelRateSec = 0.01; % CHANGED to 10ms on 20180911 - ORGINAL: 0.001;
...
if isempty(neuralDataP)|| newAcquisition==1
    t = 0;
