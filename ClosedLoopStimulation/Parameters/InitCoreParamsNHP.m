function [sCoreParams] = InitCoreParamsNHP(sCoreParams)
% Additional parameters specific to NHPs experiments
% - Plexon Acqusition
% - Stimulation
...
sCoreParams.core.maxChannelsAllNSPs = 32 * sCoreParams.core.NumberNSPs;   % max number of NSP channels (considering both NSPs)
...
%% Processing
% Channels
sCoreParams.decoders.txDetector.MaxNumberChannels = min(10,sCoreParams.core.maxChannelsAllNSPs); %How many channels can we analize at a given time - WHICH ones can change - total number is FIX
sCoreParams.decoders.txDetector.channel1 = [1:5]; %[1:sCoreParams.core.maxChannelsAllNSPs-1]; %[1 2];
