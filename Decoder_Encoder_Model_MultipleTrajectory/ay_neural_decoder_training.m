function [Xo,test_ind,training_ind]=ay_neural_decoder_training(file_name,ModelSetting)
...
% training session
training_section = ModelSetting.training_section;
% data sample
...
dValid(:,1) = dValid(:,2);
save(['Model',ModelSetting.pName,'_',num2str(ModelSetting.which_state)],'eParam','sParam','dValid','data_type','ModelSetting');
